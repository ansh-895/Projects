...
import "./stylessignc.css"; // Import the same CSS file
...
export default function SignUpClient() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    password: "",
    confirmPassword: "", // ✅ Corrected the key name here
  });
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      ...
      navigate("/loginclient"); // Redirect to Login as Client Page
    }
  };
    ...
    <div className="container">
      ...
      <div className="outer-box">
        <div className="inner-box">
          <h2 className="title">Client Signup</h2>
